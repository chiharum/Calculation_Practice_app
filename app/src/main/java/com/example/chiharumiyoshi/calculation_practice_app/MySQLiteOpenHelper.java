...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database){
        ...
        database.execSQL("create table " + FORWARD_TABLE_NAME + " (_id integer primary key autoincrement not null, calculation_kind integer not null, number1 integer not null, number2 integer not null, correct_times integer not null, total_times integer not null");
    }
